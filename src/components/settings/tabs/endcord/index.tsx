        ...
        <SettingsTab>
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Endcord you now have a cool new badge!"
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => EndcordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
...
export default wrapTab(EndcordSettings, "Endcord Settings");
