    ...
    return (
        <section className={Margins.top16}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                Settings for Notifications sent by Endcord.
    ...
    return (
        <>
            ...
            <Forms.FormText className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>Endcord Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use Endcord notifications", value: "never" },
