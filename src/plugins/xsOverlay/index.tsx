...
async function start() {
    ...
    socket = new WebSocket(`ws://127.0.0.1:${settings.store.webSocketPort ?? 42070}/?client=Endcord`);
...
const Native = EndcordNative.pluginHelpers.XSOverlay as PluginNative<typeof import("./native")>;
